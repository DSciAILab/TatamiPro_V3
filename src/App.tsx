...
import { SupabaseSessionProvider } from "@/context/supabase-session-context"; // Import SupabaseSessionProvider
import Welcome from "./pages/Welcome";
import Auth from "./pages/Auth"; // This will be updated to redirect
...
const App = () => (
  <QueryClientProvider client={queryClient}>
    <ThemeProvider defaultTheme="system" storageKey="vite-ui-theme">
      <LanguageProvider>
        <SupabaseSessionProvider> {/* Wrap with SupabaseSessionProvider */}
          <TooltipProvider>
            <Toaster />
            <Sonner />
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/auth" element={<Auth />} /> {/* This will redirect to /login */}
