...
const EventDetail: React.FC = () => {
  ...
  const athletesUnderApproval = useMemo(() => eventAthletes.filter(a => a.registrationStatus === 'under_approval'), [eventAthletes]);
  const approvedAthletes = useMemo(() => eventAthletes.filter(a => a.registrationStatus === 'approved'), [eventAthletes]);
        ...
        <>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="w-full">
              ...
              <TabsTrigger value="admin" className={userRole !== 'admin' ? 'hidden' : ''}>Admin</TabsTrigger>
              <TabsTrigger value="approvals" className={userRole !== 'admin' ? 'hidden' : ''}>Aprovações ({athletesUnderApproval.length})</TabsTrigger>
              <TabsTrigger value="divisions" className={userRole !== 'admin' ? 'hidden' : ''}>Divisões ({eventDivisions.length})</TabsTrigger>
              <TabsTrigger value="resultados">Resultados</TabsTrigger>
              <TabsTrigger value="llm">LLM (Q&A)</TabsTrigger>
            </TabsList>

            <TabsContent forceMount value="inscricoes" className="mt-6">
              <Card>
                <CardHeader>
            ...
            <TabsContent forceMount value="checkin" className="mt-6">
              <Card>
                <CardHeader>
            ...
            <TabsContent forceMount value="attendance" className="mt-6">
            ...
            <TabsContent forceMount value="brackets" className="mt-6">
              <Card>
                <CardHeader>
            ...
            <TabsContent forceMount value="admin" className="mt-6">
            ...
            <TabsContent forceMount value="approvals" className="mt-6">
              <div style={{ display: userRole === 'admin' ? 'block' : 'none' }}>
                <Card>
                  <CardHeader>
            ...
            <TabsContent forceMount value="divisions" className="mt-6">
              <div style={{ display: userRole === 'admin' ? 'block' : 'none' }}>
                <Card>
                  <CardHeader>
            ...
            <TabsContent forceMount value="resultados" className="mt-6">
              <Card>
                <CardHeader>
            ...
            <TabsContent forceMount value="llm" className="mt-6">
              <Card>
                <CardHeader>
